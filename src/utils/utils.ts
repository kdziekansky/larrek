...
/**
 * Ustawia dataset atrybuty danych elementu
 */
...
/**
 * Pobiera dane wpisane z atrybutów zestawu danych elementu
 */
...
/**
 * Sprawdź, czy jest to prosty obiekt
 */
...
/**
 * DOM Element Factory w najprostszej implementacji
 * tutaj nie bierze się pod uwagę wielu czynników
 * bardziej kompletne implementacje można znaleźć w Internecie
 */
